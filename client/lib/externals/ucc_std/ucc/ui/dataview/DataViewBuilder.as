 ...
 * Data view builder
 *
 * @version $Id: DataViewBuilder.as 42 2013-09-29 14:29:29Z rytis.alekna $
 */
	...
	protected function onResult ( result : Object ) : void {
		if ( typeof( result ) == "object" ) {
			...
			if ( this.rawDataTransformFunction ) {
				data = this.rawDataTransformFunction( result );
			} else {
				data = result as Array
			}			
			
			result = this.addDefaultData( data );
			
			this.lastResult = result as Array;
