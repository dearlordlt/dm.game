...
/**
 * 	fl.controls.dataGridClasses.DataGridColumn factory
 *
 * @version $Id: ColumnFactory.as 1 2013-01-03 11:14:03Z rytis.alekna $
 */
public class ColumnFactory {
	
	/** Data grid column */
	protected var column		: DataGridColumn;
	
	/**
	 * Class constructor
	 */
	public function ColumnFactory( dataField : String = null ) {
		this.column = new DataGridColumn( dataField );
	}
	 ...
	 * @default true
	 */
	public function setSortable ( value : Boolean = true ) : ColumnFactory {
	 ...
	 * @default true
	 */
	public function setResizable ( value : Boolean = true ) : ColumnFactory {
	 ...
	 *  @default true
	 */
	public function setEditable ( value : Boolean = true ) : ColumnFactory {
	 ...
	 */
	public function setItemEditor ( value : Object = "fl.controls.dataGridClasses.DataGridCellEditor" ) : ColumnFactory {
		this.column.itemEditor = value;
		return this;
	}
	 ...
	 *  @default "text"
	 */
	public function setEditorDataField ( value : String = "text" ) : ColumnFactory {
		this.column.editorDataField = value;
		return this;
	}
	 ...
	 */
	public function setDataField ( value : String ) : ColumnFactory {
		this.column.dataField = value;
		return this;
	}
	 ...
	 * @default false
	 */
	public function setSortDescending ( value : Boolean = false ) : ColumnFactory {
		this.column.sortDescending = value;
		return this;
	}
	 ...
	 * @default 0
	 */
	public function setSortOptions ( value : uint = 0 ) : ColumnFactory {
		this.column.sortOptions = value;
		return this;
	}
	 ...
	 * @default null
	 */
	public function setCellRenderer( value : Object ) : ColumnFactory {
		this.column.cellRenderer = value;
		return this;
	}
	 ...
	 * @default null
	 */
	public function setHeaderRenderer( value : Object ) : ColumnFactory {
		this.column.headerRenderer = value;
		return this;
	}
	 ...
	 */
	public function setHeaderText( value : String ) : ColumnFactory {
		this.column.headerText = value;
		return this;
	}
	 ...
	 *  @default null
	 */
	public function setImeMode( value : String ) : ColumnFactory {
		this.column.imeMode = value;
		return this;
	}
	 ...
	 * @default null
	 */
	public function setLabelFunction( value : Function ) : ColumnFactory {
		this.column.labelFunction = value;
		return this;
	}
	 ...
	 * @default 20
	 */
	public function setMinWidth( value : Number ) : ColumnFactory {
	 ...
	 * @default null
	 */
	public function setSortCompareFunction( value : Function ) : ColumnFactory {
		this.column.sortCompareFunction = value;
		return this;
	}
	 ...
	 * @default true
	 */
	public function setVisible( value : Boolean ) : ColumnFactory {
	 ...
	 * @default 100
	 */
	public function setWidth( value : Number ) : ColumnFactory {
	 ...
	 * @return	
	 */
	public function getColumn () : DataGridColumn {
		return this.column;
	}
