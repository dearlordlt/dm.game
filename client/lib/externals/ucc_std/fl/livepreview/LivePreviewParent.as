...
package fl.livepreview {
	 ...
	 * @productversion Flash CS3
		...
		public function LivePreviewParent()
		{
			...
			trace("fl.livepreview.LivePreviewParent.LivePreviewParent()")
			MMExecute( "fl.trace( \"MM[fl.livepreview.LivePreviewParent.LivePreviewParent()]\" )" );
			try {
				// init Stage
				...
				if (ExternalInterface.available) {
					trace( "[fl.livepreview.LivePreviewParent.LivePreviewParent] : ExternalInterface.available" );
					MMExecute( "fl.trace( \"MM[fl.livepreview.LivePreviewParent.LivePreviewParent] : ExternalInterface.available\" )" );
					stage.addEventListener( Event.RESIZE, this.onResizeEvent );
					tf.text = "[fl.livepreview.LivePreviewParent.LivePreviewParent] : ExternalInterface.available";
	 ...
	 * @productversion Flash CS3
		...
		{
			trace( "[fl.livepreview.LivePreviewParent.onResize] width: " + width );
			MMExecute( "fl.trace( \"MM[ucc.project.view.ui.window.WindowChrome.setSize] width: " + width + ", height: " + height + " );" );
			tf.text = "[fl.livepreview.LivePreviewParent.onResize] width: " + width;
	 ...
	 * @productversion Flash CS3
		...
		protected function onResizeEvent ( event : Event) : void {
			this.onResize( stage.stageWidth, stage.stageHeight );
		}
	}
}
