...
package fl.controls {
	...
	public class BaseButton extends UIComponent {
		...
		protected function drawBackground():void {
			...
			if ( !background ) {
				throw new Error( "fl.controls.BaseButton.drawBackground() : skin with name [" + getStyleValue(styleName) + "] not found! Please check library if it is not deleted or SWC library is fully merged into compilation." );
			} 
