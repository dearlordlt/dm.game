...
package fl.controls { 
	...
	public class LabelButton extends BaseButton implements IFocusManagerComponent {
		...
		public function set label(value:String):void {
			...
			// trace( "[fl.controls.LabelButton.label()] trying to set null label to LabelButton: name: " + this.name + ", value: " + value  + ", error: " + ( new Error() ).getStackTrace() );
			
			_label = Localization.getInstance().translateComplexPhrase( value );
			
			if (textField.text != _label) {
				textField.text = _label;
				// Localization.getInstance().translateTextField( this.textField );
