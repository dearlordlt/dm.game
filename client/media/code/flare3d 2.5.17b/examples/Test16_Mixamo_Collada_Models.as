package  
{
	...
	public class Test16_Mixamo_Collada_Models extends Sprite 
	{
		...
		public function Test16_Mixamo_Collada_Models() 
		{
			...
			model = scene.addChildFromFile( "walking_1.dae", null, ColladaLoader );
			
			//model = scene.addChildFromFile( "howl_1.dae", null, ColladaLoader );
			
			//model = scene.addChildFromFile( "knocked_out_7.dae", null, ColladaLoader );
			
			//model = scene.addChildFromFile( "aerial_dragon_attack_2.dae", null, ColladaLoader );
